...
def main():
    ...
    parser.add_argument('--folder_lq', type=str, default=None, help='cluster/work/cvl/juawen/dataset/CAMO/Camouflage/Images/LR_bicubic/X4')
    parser.add_argument('--folder_gt', type=str, default=None, help='cluster/work/cvl/juawen/dataset/CAMO/Camouflage/Images/Test_mod')
    ...
    for idx, path in enumerate(sorted(glob.glob(os.path.join(folder, '*')))):
        ...
        cv2.imwrite(f'{/cluster/work/cvl/juawen/projects/SwinIR}/{imgname}_SwinIR.png', output)
